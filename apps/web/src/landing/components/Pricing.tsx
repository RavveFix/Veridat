                ...
                <div class="pricing-grid">
                    ...
                    <div class="pricing-card fade-in-up delay-100">
                        <div class="pricing-header">
                            <h3 class="plan-name">Britta Start</h3>
                    ...
                    <div class="pricing-card pro-card fade-in-up delay-200">
                        ...
                        <div class="pricing-header">
                            <h3 class="plan-name">Britta Pro</h3>
                            <div class="plan-price">
                        ...
                        <a href="mailto:support@britta.ai?subject=Uppgradering till Britta Pro&body=Hej Britta-teamet!%0D%0A%0D%0AJag är intresserad av att uppgradera mitt bolag till Britta Pro. Kan ni hjälpa mig att komma igång?%0D%0A%0D%0AMed vänlig hälsning," class="btn btn-primary btn-glow">Kontakta oss för Pro</a>
